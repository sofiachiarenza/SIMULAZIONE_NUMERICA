...
int main(){
  ...
  outEP.open( "ave_epot.dat" , ios::app);
  outEK.open( "ave_ekin.dat" , ios::app);
  outET.open( "ave_etot.dat" , ios::app);
  outT.open( "ave_temp.dat" , ios::app);
  outP.open( "ave_pres.dat" );

  ifstream Epot_in , Ekin_in , Etot_in , Temp_in , Pres_in;
